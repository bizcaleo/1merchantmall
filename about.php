...
if(isset($_SESSION["cart_session"]))
{
    ...
    echo '</ul>';
    echo '<span class="check-out-txt"><strong style="color:green" ><i>Total:</i> style="color:green" >'.$currency.$total.'</strong> <a   class="a-btnjanan"  href="view_cart.php"> <span class="a-btn-text">Check Out</span></a></span>';
		...
		<div id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					...
					You can be confident when you're shopping online with T Store. Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us,
				...
				<div class="post">
					...
					<h1 align="center"><font color="blue">About The Project Manager</font></h1><br>
...
<!-- Begin Sidebar -->
		...
		<!-- End Main -->
			...
			<div class="copy">
				...
				<div class="shell">
					<div class="carts">
								<div class="shout_box">
      <div class="header"> chat with us <div class="close_btn">&nbsp;</div></div>
   ...
   <input name="shout_message" id="shout_message" type="text" placeholder="Type Message Hit Enter" maxlength="100" /> 
					...
					</div>	<p align="center">&copy; T.S Websites <a href="index.php"><i><font color="fefefe"> Welcome To <strong>T Store</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
